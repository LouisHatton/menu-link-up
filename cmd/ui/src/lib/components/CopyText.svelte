<script lang="ts">
	...
	export let text = '';
	let tooltipText: 'Copy Text' | 'Copied! 🎉' = 'Copy Text';
...
<div class="flex flex-row items-center gap-x-2">
	<div class="flex-shrink">
		<p
			class="block break-all border w-full bg-gray-50 text-gray-900 dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 p-2.5 text-sm rounded-lg cursor-text"
		>
	...
	<div>
		...
		<Tooltip class="w-28 text-center">{tooltipText}</Tooltip>
	</div>
</div>
